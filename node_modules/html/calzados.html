...
<html lang="en">
  <head>
    ...
    />
    <title>ropa shop - calzados</title>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Chakra+Petch&family=Oswald:wght@300&display=swap"
      rel="stylesheet"
    />
  ...
  <body>
    ...
    <header>
      <div>
        <img class="img-fluid" src="../imagenes/logo.png" alt="Logo" />
      </div>
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
          <img src="../imagenes/logo.png" alt="" width="50" height="48" />
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../html/calzados.html">calzados</a>
              </li>
              <li class="nav-item">
    ...
    <main>
      <!-- section catalogo de ropa con descuentos  -->
      <section class="section-calzados">
        <div>
          <h2 class="vestir">calzados de vestir</h2>
        </div>
        <div class="div__calzados">
          <div class="imagenes">
            <img
            ...
            <div class="texto-precio">
              <h5 class="texto">zapatillas deportivas negras</h5>
          ...
          <div class="imagenes">
            ...
            />
            <div class="texto-precio">
              <h5 class="texto">zapatillas de mujer plateada</h5>
          ...
          <div class="imagenes">
            ...
            />
            <div class="texto-precio">
              <h5 class="texto">zapatillas cpnverse</h5>
              <p class="texto">$2500</p>
            </div>
          </div>
          <div class="imagenes">
      ...
      <!--section seleccion de precios de los productos -->
      <div class="monto">
        <select class="form-select" aria-label="Default select example">
          ...
          <option value="$8000">$2000-8000</option>
        </select>
      </div>
    </main>
    <footer>
      <div class="div_principal">
        <div class="div__ubicacion">
          ...
          <div>
            ...
            <h4>copyright 2021© - Todos los derechos reservados</h4>
          </div>
        </div>
